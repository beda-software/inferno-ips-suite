...
module IPSTestKit
  class IPSInfernoIPSImmunizationsSectionCompositionSectionTest < Inferno::Test
    ...
    id :ips_ips_immunizations_section_composition_section_test
    ...
    run do
      ...
      target_resources_and_profiles = 'Immunization::http://hl7.org/fhir/uv/ips/StructureDefinition/Immunization-uv-ips'.split(';').map do |segment|
