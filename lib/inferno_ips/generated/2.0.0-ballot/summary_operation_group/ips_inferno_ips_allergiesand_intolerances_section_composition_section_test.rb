...
module IPSTestKit
  class IPSInfernoIPSAllergiesandIntolerancesSectionCompositionSectionTest < Inferno::Test
    ...
    id :ips_ips_allergies_and_intolerances_section_composition_section_test
    ...
    run do
      ...
      target_resources_and_profiles = 'AllergyIntolerance::http://hl7.org/fhir/uv/ips/StructureDefinition/AllergyIntolerance-uv-ips'.split(';').map do |segment|
