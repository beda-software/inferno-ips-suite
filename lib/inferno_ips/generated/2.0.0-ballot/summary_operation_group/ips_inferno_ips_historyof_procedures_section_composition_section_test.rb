...
module IPSTestKit
  class IPSInfernoIPSHistoryofProceduresSectionCompositionSectionTest < Inferno::Test
    ...
    id :ips_ips_history_of_procedures_section_composition_section_test
    ...
    run do
      ...
      target_resources_and_profiles = 'Procedure::http://hl7.org/fhir/uv/ips/StructureDefinition/Procedure-uv-ips'.split(';').map do |segment|
