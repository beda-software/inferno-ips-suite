...
module IPSTestKit
  class IPSInfernoIPSSocialHistorySectionCompositionSectionTest < Inferno::Test
    ...
    id :ips_ips_social_history_section_composition_section_test
    ...
    run do
      ...
      target_resources_and_profiles = 'Observation::http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-tobaccouse-uv-ips;Observation::http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-alcoholuse-uv-ips'.split(';').map do |segment|
