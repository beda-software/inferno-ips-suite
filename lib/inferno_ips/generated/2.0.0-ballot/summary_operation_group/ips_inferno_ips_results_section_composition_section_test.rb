...
module IPSTestKit
  class IPSInfernoIPSResultsSectionCompositionSectionTest < Inferno::Test
    ...
    id :ips_ips_results_section_composition_section_test
    ...
    run do
      ...
      target_resources_and_profiles = 'Observation::http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-laboratory-pathology-uv-ips;Observation::http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-radiology-uv-ips;DiagnosticReport::http://hl7.org/fhir/uv/ips/StructureDefinition/DiagnosticReport-uv-ips'.split(';').map do |segment|
