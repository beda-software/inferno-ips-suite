...
module IPSTestKit
  class IPSInfernoIPSMedicationSummarySectionCompositionSectionTest < Inferno::Test
    ...
    id :ips_ips_medication_summary_section_composition_section_test
    ...
    run do
      ...
      target_resources_and_profiles = 'MedicationStatement::http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationStatement-uv-ips;MedicationRequest::http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationRequest-uv-ips'.split(';').map do |segment|
